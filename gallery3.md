...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="column">
      <img class="demo cursor" src="jackpic3.jpg" style="width:100%" onclick="currentSlide(2)" alt="pic 3">
    </div>
    <div class="column">
      <img class="demo cursor" src="keltks20.png" style="width:100%" onclick="currentSlide(3)" alt="my kelt double m eb">
    </div>
    <div class="column">
      <img class="demo cursor" src="jackpic5.jpg" style="width:100%" onclick="currentSlide(4)" alt="pic 5">
    </div>
    <div class="column">
      <img class="demo cursor" src="jackpic6.jpg" style="width:100%" onclick="currentSlide(5)" alt="me in lab gear">
    </div>
    <div class="column">
